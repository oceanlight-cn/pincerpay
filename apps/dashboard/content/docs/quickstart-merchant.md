...
- [Next.js Example](/docs/example-nextjs-merchant) for App Router integration with Hono
- [Express Example](/docs/example-express-merchant) for a standalone Express server with multiple price tiers
